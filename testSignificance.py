...
if __name__ == '__main__':
    ...
    perplexityGainsPos = [dict((m, defaultdict(lambda: [])) for m in TESTED_MODEL_PAIRS) for pos in xrange(10)]
    ...
    for t in ['ll', 'perplexity']:
        ...
        for m in TESTED_MODEL_PAIRS:
            ...
            for k, gains in gainsDict.iteritems():
                ...
                if t == 'perplexity':
                    print m, 'POSITION PERPLEXITY GAINS:', k, [[f(perplexityGainsPos[pos][m][k]) for f in [avg, lambda l: bootstrap(l)[1]]] for pos in xrange(10)]
